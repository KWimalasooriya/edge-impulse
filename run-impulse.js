...
// ✅ ADD THIS FACTORY FUNCTION at the end to make classifier usable
window.EdgeImpulseClassifierFactory = async function () {
    const instance = new EdgeImpulseClassifier();
    await instance.init();
    return instance;
};
